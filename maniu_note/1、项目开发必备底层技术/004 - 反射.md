...
<img src="./004 - 反射.assets/image-20220302110522584.png" alt="image-20220302110522584" style="zoom:50%;" />
...
- 虚拟机栈（高速缓存区、线程私有区）
  - 存放方法运行所需的数据
  - 每次开一个线程都会创建一个栈帧，生命周期与线程相同
  - 栈帧由 “局部变量表、操作栈、动态连接、方法返回地址” 组成
- 本地方法栈（高速缓存区、线程私有区）
  - native方法
- 程序计数器（线程私有区）
  - 记录当前线程执行到的字节码行号
...
<img src="./004 - 反射.assets/image-20220302120151265.png" alt="image-20220302120151265" style="zoom:50%;" />
